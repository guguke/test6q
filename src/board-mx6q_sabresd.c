...
#define SABRESD_LED4	IMX_GPIO_NR(1, 30)
#define SABRESD_CODEC_EN	IMX_GPIO_NR(4, 20)
#define SABRESD_USB_ETH_EN	IMX_GPIO_NR(6, 11)
...
static struct gpio_led imx6q_gpio_leds[] = {
	GPIO_LED(SABRESD_LED1, "led1", 0, 1, "LED1"),
	GPIO_LED(SABRESD_LED2, "led2", 0, 1, "LED2"),
	GPIO_LED(SABRESD_LED3, "led3", 0, 1, "LED3"),
	GPIO_LED(SABRESD_LED4, "led4", 0, 1, "LED4"),
	GPIO_LED(SABRESD_CODEC_EN, "codec_en", 0, 1, "CODEC_EN"),
	GPIO_LED(SABRESD_USB_ETH_EN, "usb_eth_en", 0, 1, "USB_ETH_EN"),
